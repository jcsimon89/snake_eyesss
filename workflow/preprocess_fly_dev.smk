...
rule all:
    ...
    input:
        ...
        ###
        # Register Each Func Series to First Func Series
        ###
...
rule register_series:
    # register each series to the first series to correct for any drift during experiment
    # 1. register the moco mean brain from each series to the first series
    # 2. apply transform to functional data
